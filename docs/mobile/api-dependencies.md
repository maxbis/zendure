...
- The mobile page reuses the same APIs and JS as the desktop schedule page; no extra endpoints. See [docs/schedule/refresh-functions.md](../schedule/refresh-functions.md) for refresh logic.
