        ...
        <?php if (count($priceData) > 0): ?>
            <div class="card">
                <div class="info-box">
                    ...
                    <p>Interactive chart showing hourly electricity prices (€/kWh) for the last <?php echo count($dates); ?> day(s).</p>
                    <?php if (count($dates) == 2): ?>
                        <p><strong>Day 1:</strong> <?php echo formatDateDisplay($dates[0]); ?> (hours 00-23) | <strong>Day 2:</strong> <?php echo formatDateDisplay($dates[1]); ?> (hours 00-23)</p>
                    <?php endif; ?>
                </div>
            ...
            options: {
                ...
                scales: {
                    x: {
                        title: {
                            display: true,
                            text: 'Hours (Day 1: 00-23, Day 2: 00-23)',
                            font: {
                                size: 14,
                                weight: 'bold'
                            }
