...
<body>
    <main class="daily-report-shell">
        <section class="hero-card">
            <div class="hero-copy">
                <p class="eyebrow">Aggregate Table Prototype</p>
                <h1><a class="hero-title-link" href="daily_report_v2.php">Daily Report V2</a></h1>
                <p class="hero-text">
                    A validation view for the hourly aggregate table. It keeps the current daily report untouched
                    while reading battery, grid, and price inputs from hourly_report_inputs.
                </p>
            </div>
            <div class="hero-meta">
                <nav class="view-switch" aria-label="Report views">
                    <a href="./?date=<?php echo htmlspecialchars($requestedDate, ENT_QUOTES, 'UTF-8'); ?>">Daily</a>
                    <span class="view-switch__sep" aria-hidden="true">&middot;</span>
                    <span class="view-switch__current">V2</span>
                    <span class="view-switch__sep" aria-hidden="true">&middot;</span>
        ...
        <section class="status-grid status-grid--eight">
            ...
            <article class="summary-card summary-card--savings">
                ...
                <div class="summary-subtle">Discharged kWh &times; hourly price</div>
            </article>
            <article class="summary-card summary-card--charge-cost">
                ...
                <div class="summary-subtle">Charged kWh &times; hourly price</div>
            </article>
        ...
        <section class="detail-grid">
            ...
            <article class="detail-card">
                ...
                <dl class="metric-list">
                    ...
                    <div><dt>Price source</dt><dd data-role="meta-price-file">--</dd></div>
